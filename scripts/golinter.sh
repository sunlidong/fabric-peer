...
context_whitelist=(
    "^fabricbypeer/core/comm/testpb:"
    "^fabricbypeer/orderer/common/broadcast/mock:"
    "^fabricbypeer/common/grpclogging/fakes:"
    "^fabricbypeer/common/grpclogging/testpb:"
    "^fabricbypeer/common/grpcmetrics/fakes:"
    "^fabricbypeer/common/grpcmetrics/testpb:"
)

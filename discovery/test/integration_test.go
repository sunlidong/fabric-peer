...
import (
	...
	bccsp "fabricbypeer/bccsp/utils"
	...
	lifecyclemocks "fabricbypeer/core/cclifecycle/mocks"
	"fabricbypeer/core/comm"
	"fabricbypeer/core/common/ccprovider"
	"fabricbypeer/discovery"
	disc "fabricbypeer/discovery/client"
	...
	"fabricbypeer/discovery/support/mocks"
	"fabricbypeer/gossip/api"
	gcommon "fabricbypeer/gossip/common"
	gdisc "fabricbypeer/gossip/discovery"
...
func buildBinaries() error {
	var err error
	cryptogen, err = gexec.Build("fabricbypeer/cmd/cryptogen")
	if err != nil {
		return errors.WithStack(err)
	}

	idemixgen, err = gexec.Build("fabricbypeer/cmd/idemixgen")
	if err != nil {
		return errors.WithStack(err)
	}
	return nil

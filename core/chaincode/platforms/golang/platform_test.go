...
import (
	...
	"fabricbypeer/core/chaincode/platforms/util"
	"fabricbypeer/core/config/configtest"
...
func TestValidatePath(t *testing.T) {
	var tests = []struct {
		...
		{path: "http://fabricbypeer/core/chaincode/platforms/golang/testdata/src/chaincodes/noop", succ: false},
		{path: "https://fabricbypeer/core/chaincode/platforms/golang/testdata/src/chaincodes/noop", succ: false},
		{path: "fabricbypeer/core/chaincode/platforms/golang/testdata/src/chaincodes/noop", succ: true},
		{path: "fabricbypeer/bad/chaincode/golang/testdata/src/chaincodes/noop", succ: false},
		{path: ":fabricbypeer/core/chaincode/platforms/golang/testdata/src/chaincodes/noop", succ: false},
	}
...
func TestNormalizePath(t *testing.T) {
	...
	var tests = []struct {
		...
		{path: "fabricbypeer/cmd/peer", result: "fabricbypeer/cmd/peer"},
...
func TestGopathDeploymentPayload(t *testing.T) {
	...
	payload, err := platform.GetDeploymentPayload("fabricbypeer/core/chaincode/platforms/golang/testdata/src/chaincodes/noop")
	assert.NoError(t, err)
...
func TestGetDeploymentPayload(t *testing.T) {
	const testdata = "fabricbypeer/core/chaincode/platforms/golang/testdata/src/"

...
func (c *Components) ConfigTxGen() string {
	return c.Build("fabricbypeer/cmd/configtxgen")
}

func (c *Components) Cryptogen() string {
	return c.Build("fabricbypeer/cmd/cryptogen")
}

func (c *Components) Discover() string {
	return c.Build("fabricbypeer/cmd/discover")
}

func (c *Components) Idemixgen() string {
	return c.Build("fabricbypeer/cmd/idemixgen")
}

func (c *Components) Orderer() string {
	return c.Build("fabricbypeer/cmd/orderer")
}

func (c *Components) Peer() string {
	return c.Build("fabricbypeer/cmd/peer")
}

...
`configtx.yaml`. You can look at a [sample `configtx.yaml` file here](http://fabricbypeer/blob/release-1.2/sampleconfig/configtx.yaml).
...
followed by a string. To see what this looks like, reference this [sample configtx.yaml file](https://fabricbypeer/blob/release-1.2/sampleconfig/configtx.yaml).

...
To look at a sample `orderer.yaml`, check out the [`fabric-samples` github repo](https://fabricbypeer/blob/release-1.4/sampleconfig/orderer.yaml), which **should be read and studied closely** before proceeding.

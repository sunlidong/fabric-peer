...
The Fabric project is lead by the project's top level `maintainers <https://fabricbypeer/blob/master/MAINTAINERS.md>`__.
...
change set to the `maintainers <https://fabricbypeer/blob/master/MAINTAINERS.md>`__ file. A nominated
...
<https://fabricbypeer/pulls>`__ to get started.
...
<https://fabricbypeer/blob/master/docs/source/dev-setup/headers.txt>`__.

We have tried to make it as easy as possible to make contributions. This
applies to how we handle the legal aspects of contribution. We use the
same approach—the `Developer's Certificate of Origin 1.1
(DCO) <https://fabricbypeer/blob/master/docs/source/DCO1.1.txt>`__—that the Linux® Kernel
